...
JAR=$MDPATH/src/lib
java -cp $JAR/joda-convert-1.2.jar:$JAR/joda-time-2.9.3.jar:$JAR/json4s-ast_2.11-3.3.0.jar:$JAR/json4s-core_2.11-3.3.0.jar:$JAR/json4s-native_2.11-3.3.0.jar:$JAR/json4s-scalap_2.11-3.3.0.jar:$JAR/nscala-time_2.11-2.12.0.jar:$JAR/paranamer-2.8.jar:$JAR/scala-library-2.11.8.jar:$JAR/scala-xml_2.11-1.0.5.jar:$MDPATH/src/venmo_payments_v2_2.11-1.0.jar VenmoPayments $MDPATH/venmo_input/venmo-trans.txt $MDPATH/venmo_output/output.txt
